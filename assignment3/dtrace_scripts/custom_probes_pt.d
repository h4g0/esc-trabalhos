...
pt*:::finish_sorting_into_buckets
...
pt*:::start_copy_to_main_array
{
	started_section[arg2,arg1,"copy_to_main_array"] = timestamp;
}

pt*:::finish_copy_to_main_array
...
pt*:::start_allocate_temp_array
{
	started_section[arg2,arg1,"allocate_temp_array"] = timestamp;
}

pt*:::finish_allocate_temp_array
...
pt*:::start_workload_distribution
{
    started_section[arg2,arg1,"workload_distribution"] = timestamp;

}

pt*:::finish_workload_distribution
